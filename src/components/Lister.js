    ...
    return (
      <React.Fragment>
        <ListItem key={key} alignItems="flex-start">
          ...
          <ListItemText
            primary={notes.organization ? notes.organization : "Private"}
            secondary={<React.Fragment>{notes.comment}</React.Fragment>}
          />
...
class Lister extends React.Component {
  ...
  render() {
    ...
    return (
      <List style={{ minWidth: "300px" }} className={classes.root}>
