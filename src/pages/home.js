...
export class home extends Component {
    render() {
      ...
      justify="center" align = "center" container style={{ minHeight: '100vh', paddingTop:'10rem'}} >
       ...
       <div className ="bio " > 
        <h1 >Roscoe.js</h1> 
        <p> <div className="bioname">  Hi! I'm Roscoe </div>, nice to meet you and have a look around</p>

        <p> I have a passion for not only thoughtful UI but overall flow and feeling of the application. I enjoy building user interfaces and designing back-end solutions  </p>
 ...
 <div className="hexagon">
  ...
  <EmojiObjectsIcon  style = {{color:"white",fontSize:'60px'}}/>
  <h3>Intuitive</h3>
