 ...
 class skills extends Component {
    ...
    render() {
      ...
      const sk =   SkillData.map((skill,index) => {
            ...
            <PrettoSlider   valueLabelDisplay="auto" aria-label="pretto slider" defaultValue={skill.level}  />
             <ListItemText
             style ={{fontFamily:'Open Sans',marginLeft:'50px', textAlign:'right'}} primary= {skill.name} width = {40} />
          </ListItem> 
            )
